...
import {type BreadcrumbItem, Timing} from '@/types';
...
export default function EditTiming({ timing }: { timing: Timing }) {
    const name = useRef<HTMLInputElement>(null);
    const egn = useRef<HTMLInputElement>(null);
    const email = useRef<HTMLInputElement>(null);
    const phone = useRef<HTMLInputElement>(null);
    const description = useRef<HTMLInputElement>(null);
    const currentDate = new Date(timing.value);
    ...
    const { data, setData, errors, put, reset, processing, recentlySuccessful } = useForm<Required<EditTimingForm>>({
        name: timing.name,
        egn: timing.egn,
        email: timing.email,
        phone: timing.phone,
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('timing.update', timing.id), {
            preserveScroll: true,
            onSuccess: (): void => {
                reset();
